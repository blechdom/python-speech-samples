...
Example usage:
    python transcribe_streaming_indefinite_dlp.py -p <PROJECTID>
"""
...
def listen_print_dlp_loop(responses, stream, projectID):
...
def main(projectID):
    ...
    with mic_manager as stream:
        while not stream.closed:
            ...
            listen_print_dlp_loop(responses, stream, projectID)
